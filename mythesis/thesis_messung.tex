...
\begin{figure}[h]
	...
	\begin{subfigure}{1\textwidth}
		...
		\caption{Bla2}
	\end{subfigure}
	\caption{Qualitative Darstellung des elektrischen Feldes der $\mathrm{TM}_{111}$-Mode zu einem festen Zeitpunkt (Simulation durch CST-MWS). Gezeigt ist der Querschnitt des Resonator-Modells mit der Strahlenachse in der Ebene. \todo{Captions}}
