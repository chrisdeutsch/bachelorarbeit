...
Bevor eine Interpretation der Shuntimpedanzen stattfindet, sollen die gemessenen Feldverteilungen diskutiert werden.
Zunächst fällt beim Betrachten der Feldverteilungen in Abschnitt \ref{app:hom_felder} auf, dass Sprünge des effektiven elektrischen Feldes auftreten.
Diese Sprünge entstehen an Stellen an denen das elektrische Feld einen Phasensprung vollzieht und ist auf das begrenzte (Orts-)Auflösungsvermögen des verwendeten Störkörpers zurückzuführen.
Bei der Bestimmung der Shuntimpedanzen durch Integration stellen die Sprungstellen keinen signifikanten Einfluss dar, da deren Anzahl klein ist gegen die Anzahl der Messpunkte pro Messung (434).
Dennoch stellt die Verwendung eines kleineren Störkörpers eine Möglichkeit dar, die Sprünge zu Vermindern.
Jedoch steht dies mit einer reduzierten Frequenzverschiebung zusammen und erfordert unter Umständen eine Temperaturstabilisierung von Resonator und VNA.

Ferner fällt auf, dass kleine elektrische Feldamplituden nicht gut aufgelöst werden können.
Dies ist zurückzuführen auf das begrenzte (Frequenz-)Auflösungsvermögen des VNA und der Abhängigkeit der (normierten) elektrischen Feldamplitude von der Frequenzverschiebung $\Delta \omega$ durch den Störkörper:
\begin{align}
	\frac{|\ve_0|}{\sqrt{P_\mathrm{V}}} \propto \sqrt{\Delta \omega} \eqdot
\end{align}
...
Die höchste effektive Shuntimpedanz der vermessenen Resonatormoden zeigt die $\mathrm{TE}_{111}$-Mode mit \SI{326+-11}{\kilo\ohm} (transversal).
