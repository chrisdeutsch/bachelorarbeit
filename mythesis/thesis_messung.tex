...
Dadurch das ein vereinfachtes Modell der Kavität genutzt wird, kommt es teilweise zu großen Abweichungen der Resonanzfrequenz zwischen Simulation und Messung.
...
Beim Betrachten der Feldverteilungen in Abschnitt \ref{app:hom_felder} fällt auf, dass es teilweise zu Sprüngen des effektiven elektrischen Feldes kommt.
Diese Sprünge entstehen an Stellen an denen das elektrische Feld einen Phasensprung vollzieht und ist zurückzuführen auf das begrenzte Auflösungsvermögen des verwendeten Störkörpers.
Eine Möglichkeit diese Sprünge zu Vermindern ist die Verwendung eines kleineren Störkörpers, was jedoch mit einer reduzierten Frequenzverschiebung zusammenhängt und unter Umständen eine Temperaturstabilisierung von Resonator und VNA voraussetzt.
