...
Dazu wurden Simulationen der Eigenmoden eines vereinfachten Modells des siebenzelligen PETRA-Resonators \todo{Schedler} mit \textit{CST Microwave Studio\textsuperscript{\textregistered}} (CST-MWS) durchgeführt.
...
Außerdem wurde die Zelle der Einkopplung ohne Koppelschleife modelliert.
...
In Abbildung \ref{fig:cst_sim_tm111} wurde exemplarisch die elektrische Feldstärke der vermessenen $\mathrm{TM}_{111}$-Mode bei fester Phase aufgetragen. 
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{./figs/TM111-CST/TM111_cut.png}
	\caption{Simulation des elektrischen Feldes durch CST-MWS. Gezeigt ist der Querschnitt des Resonator-Modells mit der Strahlenachse in der Ebene. $\mathrm{TM}_{111}$-Mode mit der gemessenen Resonanzfrequenz $\nu_0 = \SI{1047.23}{MHz}$. \todo{Caption Schön}}
...
Dies ist zwischen der zweiten und dritten Zelle in Abbildung \ref{fig:cst_sim_tm111} zu beobachten und wurde konnte zur eindeutigen Identifikation der meisten Resonatormoden und deren Phasenbeziehung genutzt werden.
Für zwei der vermessenen Moden war keine eindeutige Bestimmung der Phasenbeziehung möglich, weshalb dort der Fall höchster Shuntimpedanz betrachtet wurde.

Für Moden höherer Ordnung können gemäß Abschnitt \ref{sec:em_felder_in_resonatoren} Vorzeichenwechsel des elektrischen Feldes in den Zellen auftreten.\todo{Den Kram erklären}

Die restliche Auswertung folgt analog zu \ref{sec:tm010_messung} und die Ergebnisse wurden in Tabelle \ref{tab:shuntimpedanzen_hom} zusammengefasst.
