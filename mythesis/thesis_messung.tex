...
Somit fällt die Güte von PETRA-III mit \num{29556+-110} in den Bereich der Herstellerangaben.
Lediglich PETRA-IV mit einer Güte von \num{28200+-176} fällt nicht in diese Grenzen.
\todo{Beide Resonatoren unterschreiten die nominale Güte, was möglicherweise durch deren Belüftung zu erklären ist.}
Im Folgenden wird diese Abweichung auch bei den Shuntimpedanzen auftreten, da diese linear Abhängigkeit von der Güte der Resonatormode aufweist.
Demnach zeigt PETRA-III eine effektive Shuntimpedanz von \SI{25.65+-0.91}{\mega\ohm} und PETRA-IV \SI{24.47+-0.87}{\mega\ohm}.
Da der Geometriefaktor unabhängig von den Verlusten des Resonators ist, sollte dieser 
\begin{align}
	\frac{R_\mathrm{S}^\mathrm{eff}}{Q_0} = \SI{868+-32}{\ohm}
\end{align}
Simulation mit MAFIA\texttrademark\footnote{Programm zur numerischen Simulation elektromagnetischer Felder und Vorgänger des \textit{CST Microwave Studio}.} liefert den Geometriefaktor \SI{856}{\ohm}




+ $U_\mathrm{eff}$ bie $P_\mathrm{ELSA}$\\
-andere Moden\\
