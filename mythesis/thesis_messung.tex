...
In Abbildung \ref{fig:cst_sim} wurde exemplarisch die elektrische Feldstärke einer der vermessenen $\mathrm{TM}_{021}$-Moden zu einer festen Phase aufgetragen. 
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{./figs/TM021-CST/1465_R_cut.png}
	\caption{CST-Simulation des elektrischen Feldes einer der vermessenen $\mathrm{TM}_{021}$-Moden \mbox{($\nu_0 = \SI{1465.83}{MHz}$)}. Gezeigt ist der Querschnitt des Resonator-Modells mit der Strahlenachse in der Ebene. }
	\label{fig:cst_sim}
\end{figure}
