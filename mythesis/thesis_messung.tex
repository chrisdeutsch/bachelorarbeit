...
Abschließend soll die Diskussion der effektiven Shuntimpedanzen der einzelnen Moden folgen.
Die größte effektive Shuntimpedanz der im Rahmen dieser Arbeit vermessenen Moden zeigt die $\mathrm{TE_{111}}$-Mode



Die größte effektive Shuntimpedanz zeigt die  mit $R_\mathrm{S}^\mathrm{eff} = \SI{326 +- 11}{\kilo\ohm}$ (transversal), was einem Geometriefaktor von \SI{29.21 +- 0.05}{\ohm} entspricht.
