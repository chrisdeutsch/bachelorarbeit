...
Wird eine Messung von $\nu_\mathrm{ref}$ und $\nu_0(z)$ mit zeitlich kurzem Abstand, sodass die Temperaturänderung vernachlässigt werden kann, durchgeführt


bei fester Resonatortemperatur durchgeführt und die Differenz~$\nu_0(z) - \nu_\mathrm{ref}$ gebildet.
Man stellt fest, dass die Differenz 



Wird eine Messung von $\nu_\mathrm{ref}$ und $\nu_0(z)$ bei fester Resonatortemperatur durchgeführt und die Differenz~$\nu_0(z) - \nu_\mathrm{ref}$ betrachtet, so stellt man fest, dass diese für kleine Temperaturänderungen konstant beibt.



Wird jedoch die Differenz~$\nu_0(z) - \nu_\mathrm{ref}$ betrachtet, so stellt man fest, dass diese im Hinblick auf typische Temperaturänderungen während einer Messung konstant ist \cite{schedler_pm}\todo{???}.
