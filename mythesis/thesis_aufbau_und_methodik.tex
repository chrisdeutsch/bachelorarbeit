...
Zunächst wird der Störkörper an die Referenzposition gefahren,


Störkörpermessprogramm:
\begin{itemize}
  \item Fahre durch den Resonator in \SI{5}{mm}-Schritten
  \item Messe Referenzposition
  \item Messe nächste Position
  \item print pos, freq, fref, freq-fref
\end{itemize}

Miss: fahre zur Position; warte die Einschwingzeit ab; miss AVG-Sweeps mit dem VNA; Bestimme die Resonanzfrequenz durch die Minimumsfunktion des VNA.
