...
\begin{figure}[htb]
  ...
  \caption[Schematische Darstellung eines siebenzelligen PETRA-Resonators]{Schematische Darstellung des Querschnitts eines siebenzelligen PETRA-Resonators mit Koppelschleife und zwei Abstimmstempeln. Der Abstand zweier benachbarten Zellen beträgt \SI{30}{\centi\metre} und die Gesamtlänge des Resonators von Flansch zu Flansch \SI{222}{\centi\metre}.}
...
Diese sogenannten \textit{Nasenkegel} (engl.\ \textit{nose cones}) erzeugen eine Erhöhung der elektrischen Feldstärke auf der Strahlachse bei gleichzeitiger Verkürzung der Beschleunigungsstrecke und führen zu einem Anstieg des Laufzeitfaktors \eqref{eq:laufzeitfaktor} gegenüber einer Kavität ohne \textit{Nasenkegel} \cite{wangler}.
...
\end{align}
annehmen \cite{wangler}. Die Benennung orientiert sich an den Werten von~$\Delta \varphi$ (z.\ B.\ $\pi$-Mode für $\Delta \varphi = \pi$), sodass für den siebenzelligen PETRA-Resonator folgende Moden existieren:
\begin{align}
...
Außerdem zeigt PTFE keine signifikante Frequenzabhängigkeit der relativen Permittivität~$\varepsilon_\mathrm{r}$ auf dem in dieser Arbeit betrachteten Frequenzbereich \cite{CRC}.
...
Die Drehung der Spindel erfolgt dabei durch den 2-Phasen Schrittmotor \textit{MDrive\textsuperscript{\textregistered} 23 Plus Motion Control} des Herstellers Schneider Electric \cite{motor_datasheet}.
...
Aus der Geometrie der Spindel folgt für die zugehörige Proportionalitätskonstante ca.\ \SI[per-mode = symbol]{0.006}{\milli\metre\per\micro\step}.
...
Der limitierende Faktor für die Genauigkeit der Störkörperpositon liegt demnach nicht in der Stellgenauigkeit des Motors, sondern in der ungleichen mechanischen Verspannung des Kunststofffadens aufgrund von Reibung in den Lagern der Umlenkrollen.
...
Zur Bestimmung der Resonanzfrequenz und Güte einer Resonatormode dient der vektorielle Netzwerkanalysator \textit{ZVC 1127.8600.62} von Rohde \& Schwarz.
