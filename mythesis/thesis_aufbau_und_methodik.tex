...
Die $N$ Moden der Resonatorkette unterscheiden sich neben der Resonanzfrequenz $\omega_0$ auch im Phasenvorschub $\Delta \varphi$ zwei benachbarter Zellen und kann ausgedrückt werden durch \cite[S.\ 24]{tenenbaum}:
\begin{align}
  \Delta \varphi_n = n \cdot \frac{\pi}{N-1} \quad \text{mit} \quad n = 0, \dots, N-1
\end{align}
In der Regel werden die Moden der Resonatorkette nach ihrem Phasenvorschub benannt (z.B.\ $\pi$-Mode für $\Delta \varphi = \pi$).
