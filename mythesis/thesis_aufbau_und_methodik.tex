...
Zur Realisierung einer automatisierten Störkörpermessung und der Koordination von Schrittmotor und Netzwerkanalysator dient der Mikrocomputer \textit{Raspberry Pi} (RPi).
Die Kommunikation des RPi mit den einzelnen Komponenten erfolgt über deren serielle Schnittstelle.
Dazu wurden die jeweiligen Kommunikationsprotokolle in der Programmiersprache \textit{Python\texttrademark}
