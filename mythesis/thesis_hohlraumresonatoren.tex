...
\end{figure}
Die elektrischen Eigenschaften von Hohlraumresonatoren können in einem beschränkten Frequenzbereich um eine Resonanz durch das Modell des Parallelschwingkreises (siehe Abb.\ \ref{fig:rlc_circuit}) erklärt werden \cite{wille, pozar}.
...
Mit der Definition des Koppelfaktors~$\kappa$, der Proportionalität $Z^\prime(\omega) \propto Z(\omega)$ für ideale Transformatoren und der Impedanz des Resonators im Resonanzfall $Z(\omega_0) = R$ folgt die Frequenzabhängigkeit der Impedanz~$Z^\prime(\omega)$ des Systems bestehend aus Koppelschleife und Resonator:
\begin{align}
