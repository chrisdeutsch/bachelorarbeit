\begin{tabular}{
	...
	\multicolumn{7}{l}{
		\small{
			\textsuperscript{\textasteriskcentered}: Resonatormode ist nicht durch Moden zylindrischer Resonatoren beschreibbar
		}
	}\\
	\multicolumn{7}{l}{
		\small{
			\textsuperscript{\textdagger}: Für die Phasenbeziehung wird der Fall der höchsten effektiven Shuntimpedanz angenommen
		}
	}\\
	\bottomrule
\end{tabular}
