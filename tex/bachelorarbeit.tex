...
\begin{document}
	...
	Die Lösung der \textsc{Maxwell}-Gleichungen unter Beachtung dieser Grenzbedingungen zeigt, dass in Abhängigkeit der Geometrie des Hohlraums, nur eine unbegrenzte Anzahl von Moden mit bestimmten Frequenzen im Resonator auftreten können.
	...
	\end{align}
	Die Mode mit der niedrigsten Frequenz (Fundamentalmode) ist damit $\mathrm{TM}_{010}$, welche in Abbildung 
	
	Eine analytische Berechnung von komplexeren Resonatorgeometrien 
	\emph{CST Microwave Studio\textsuperscript{\textregistered}}
	...
	\end{figure}
	Die elektrischen Eigenschaften von Hohlraumresonatoren in der Nähe einer Resonanz können durch das Modell eines Parallelschwingkreises erklärt werden. (Mit wesentlich höherer Güte)
