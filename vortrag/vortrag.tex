...
\begin{frame}
	...
	\begin{tabular}{p{3.5cm}|cc} \toprule
		$\mathrm{TM}_{010}$-$\pi$-Mode & \textbf{PETRA-I} & \textbf{PETRA-II} \\ \midrule
		Kreisgüte $Q_0$ & \num{29560 +- 110} & \num{28200 +- 180} \\
...
\begin{frame}{Moden höherer Ordnung}
	\begin{itemize}
		\setlength\itemsep{1.25em}
		\item \textbf{Erwartung:} hohe Shuntimpedanz der $\mathrm{TM}_{021}$-Moden
		\begin{itemize}
			\item größte Shuntimpedanz (4/7)
			\begin{align*}
				\nu_0 = \SI{1465.8}{\mega\hertz}\qquad R_\mathrm{S} = \SI{183.0 +- 6.4}{\kilo\ohm}
			\end{align*}
			
			\item mehrere Größenordnungen unter der Beschleunigermode
		\end{itemize}
		
		\item höchte gemessene Shuntimpedanz:
		\begin{align*}
