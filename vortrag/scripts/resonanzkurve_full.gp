...
set output './plots/resonanzkurve_full.tex'
...
plot rho(x) ls 1 t'$Q_0 = 500, \kappa = 1{,}0$', rho2(x) ls 2 t'$Q_0 = 250, \kappa = 1{,}0$', rho3(x) ls 3 t'$Q_0 = 500, \kappa = 0{,}5$', rho4(x) ls 4 t'$Q_0 = 500, \kappa = 2{,}0$'
