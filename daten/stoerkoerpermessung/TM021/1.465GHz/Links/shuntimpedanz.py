...
Q0 = ufloat(25279.0, 50.0)
v0 = ufloat(1464.566E+6, 0.001E+6)
...
# Daten einlesen
data = np.loadtxt("TM021_zweite_messung.tsv")
...
phase[0:45-7] = 0
phase[45-7:74-7] = np.pi

# Übergang nicht klar ersichtlich aber egal, da kein phasensprung
phase[74-7:103-7] = np.pi
phase[103-7:134-7] = 0

# Übergang nicht klar ersichtlich aber egal, da kein phasensprung
phase[134-7:165-7] = 0
phase[165-7:194-7] = np.pi

# Übergang nicht klar ersichtlich aber egal, da kein phasensprung
phase[194-7:226-7] = np.pi
phase[226-7:254-7] = np.pi

# Übergang nicht klar ersichtlich aber egal, da kein phasensprung
phase[254-7:285-7] = np.pi
phase[285-7:314-7] = 0

# Übergang nicht klar ersichtlich aber egal, da kein phasensprung
phase[314-7:347-7] = 0
phase[347-7:374-7] = np.pi

# Übergang nicht klar ersichtlich aber egal, da kein phasensprung
phase[374-7:404-7] = np.pi
phase[404-7:434] = 0
