...
Q0 = ufloat(31356.0, 217.0)
v0 = ufloat(501.034E+6, 0.001E+6)
...
phase[0:76-7] = 0
phase[76-7:134-7] = 1 * 2.0 / 3.0 * np.pi
phase[134-7:193-7] = 2 * 2.0 / 3.0 * np.pi
phase[193-7:255-7] = 3 * 2.0 / 3.0 * np.pi
